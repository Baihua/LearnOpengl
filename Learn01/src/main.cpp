...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("../../shader/show.vs", "../../shader/show.fs");

    // set up vertex data (and buffer(s)) and configure vertex attributes
    // ------------------------------------------------------------------
    float vertices[] = {
        // positions          // colors           // texture coords
         1.00f,  1.0f, 0.0f,   1.0f, 1.0f, 1.0f,   1.0f, 0.0f, // top right
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // render container
        ourShader.use();
        glUniform1i(glGetUniformLocation(ourShader.ID, "ourTexture"), 0); // ÊÖ¶¯ÉèÖÃ
        glBindVertexArray(VAO);
